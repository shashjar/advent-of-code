...
def calculate_antinode_positions(matrix, pos1, pos2):
    ...
    antinode_pos1 = (pos2[0] + row_diff, pos2[1] + col_diff)
    antinode_pos2 = (pos1[0] - row_diff, pos1[1] - col_diff)

    if on_grid(antinode_pos1, matrix):
        antinode_positions.append(antinode_pos1)

    if on_grid(antinode_pos2, matrix):
