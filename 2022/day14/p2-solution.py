...
def main():
    ...
    # add floor points to rock locations
    floorY = lowestRockYCoord + 2
    ...
    while (500, 0) not in sandLocations:  # loop until sand blocks the entry point
        sandLocation = (500, 0)
        while True:  # loop to drop this current sand unit until it comes to rest or falls forever
            ...
            # below location blocked
            if belowLocation in rockLocations or belowLocation in sandLocations or belowLocation[1] == floorY:
                diagonalLeft = (sandLocation[0] - 1, sandLocation[1] + 1)
                if diagonalLeft in rockLocations or diagonalLeft in sandLocations or diagonalLeft[1] == floorY:  # diagonal left location blocked
                    diagonalRight = (sandLocation[0] + 1, sandLocation[1] + 1)
                    if diagonalRight in rockLocations or diagonalRight in sandLocations or diagonalRight[1] == floorY:  # diagonal right location blocked
